...
import { ResetPassword, ResetToken } from "@/interfaces/auth/auth";
import {
  emailPattern,
  passwordPattern,
  ...
  const getToken = (
    <div className="sign-up">
      ...
      <div className="form">
        ...
        <p className="desc">
          Enter your email address and we’ll email you a code for your password
          reset
        </p>
        <div className="content">
          <form onSubmit={handleSubmit(sendToken)}>
            <div className="input">
              ...
              <input
                type="text"
                placeholder="lamburghinie@mail.com"
                {...mail("email", {
          ...
          <p onClick={signIn} className="account">
    ...
    <div className="sign-up">
      ...
      <div className="form">
        ...
        <p className="desc">
          ...
          upper and lowercase letters, special character and number
        </p>
        <div className="content">
          <form onSubmit={handleResetSubmit(handleReset)}>
            ...
            <div className="input">
              ...
              <input
                ...
                {...reset("token", { required: "Token required" })}
              />
            ...
            <div className="input">
              ...
              <div className="password">
                ...
                />
                <Image
                  src={`/images/general/auth/${
                    show ? "eye-show" : "eye-hide"
                  }.png`}
                  alt="img"
            ...
            <div className="input">
              ...
              <div className="password">
                <input
                  ...
                  {...reset("confirmPassword", {
                    ...
                    validate: () => {
                      return watch1("confirmPassword") == watch1("password");
                    },
                  })}
                />
                <Image
                  src={`/images/general/${show1 ? "eye-show" : "eye-hide"}.png`}
                  alt="img"
              ...
              {watch1("confirmPassword") !== watch1("password") &&
                getValues1("confirmPassword") && <p>Passwords do not match</p>}
            </div>
            <button type="submit">Continue</button>
          </form>
          <p onClick={signIn} className="account">
